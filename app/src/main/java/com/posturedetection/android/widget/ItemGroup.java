...
public class ItemGroup extends FrameLayout {
    ...
    private void initView(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.layout_profile_item, null);
        itemGroupLayout = (LinearLayout) view.findViewById(R.id.layout_profile_item);
